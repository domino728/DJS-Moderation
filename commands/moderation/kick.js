...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!Member)
      return message.channel.send(
        `:x: Please Mention A Member That You Want To Kick!`
      );
    ...
    if (Member.id === message.author.id)
      return message.channel.send(`:x: You Can't Kick Your Self!`);

    if (Member.id === client.user.id)
      return message.channel.send(`:x: You Can't Kick Bots!`);

    if (Member.id === message.guild.owner.user.id)
      return message.channel.send(`:x: You Can't Kick Owner Of Server!`);
    ...
    if (!User.kickable)
      return message.channel.send(`:x: I Can't Kick That Member!`);
    ...
    try {
      ...
      return message.channel
        .send(
          `:x: I Can't Kick That Member Maybe Member Has Higher Role Than Me & My Role Is Lower Than Member!`
        )
